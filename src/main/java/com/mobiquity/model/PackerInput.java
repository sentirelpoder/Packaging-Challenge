...
public class PackerInput {
     ...
     */
    public PackerInput(String line) throws NoItemToChooseException, TooManyItemsException, CapacityOverloadException, ExpensiveItemException, TooHeavyItemException {
