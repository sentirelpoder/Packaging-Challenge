...
class PackageFileParserTest {
    ...
    @Test
    void testGetItemListPartOfLineExampleOne() {
    ...
    @Test
    void testGetItemListPartOfLineExampleTwo() {
    ...
    @Test
    void testGetItemListPartOfLineExampleThree() {
    ...
    @Test
    void testGetItemListPartOfLineExampleFour() {
